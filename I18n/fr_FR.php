...
return [
    ...
    'Add a new attribute value' => 'Ajouter une nouvelle valeur de déclinaison',
    ...
    'Create this order status' => 'Créer ce statut de commande',
    ...
    'Delete an order status' => 'Supprimer un statut de commande',
    ...
    'Delete this order status' => 'Supprimer ce statut de commande',
    ...
    'Do you really want to delete this address ?' => "Voulez-vous vraiment supprimer cette adresse\u{a0}?",
    ...
    'Do you really want to delete this order status ?' => 'Supprimer définitivement ce statut de commande ?',
    ...
    'Download purchase order as PDF' => 'Télécharger le bon de livraison au format PDF',
    ...
    'Edit order status %title' => 'Modifier du statut de commande "%title"',
    ...
    'Edit this order status' => 'Modifier ce statut de commande',
    ...
    'Editing order status "%title"' => 'Modification du statut de commande "%title"',
    ...
    'Enter new order status position' => 'Indiquez la position du statut de commande',
    ...
    'Items taxes' => 'Taxes sur les articles',
    ...
    'More results are available.' => 'D\'autres résultats ont été trouvés',
    'Name' => 'Nom',
    'Namespace of main class' => 'Espace de noms de la classe principale',
    'New' => 'Nouveau',
    'New Configuration' => 'Nouvelle Configuration',
    'No' => 'Non',
    'No API key has been created yet. Click the [+} button to create one.' => 'Aucune clef d\'API n\'a encore été créée',
    ...
    'No brand found for "%term"' => 'Aucune marque trouvée pour "%term" ',
    ...
    'No coupon for this order' => 'Pas de code promo sur cette commande',
    ...
    'No transaction for this order' => 'Pas de transaction pour cette commande',
    ...
    'Order n°' => 'Commande n°',
    'Order path configuration' => 'Configuration du tunnel de commande',
    'Order placed on %order_date at %order_time' => 'Commande passée le %order_date à %order_time',
    'Order status' => 'Statuts de commande',
    'Order status created on %date_create. Last modification: %date_change' => 'Statut de commande crée le %date_create. Dernière modification: %date_change',
    'Order status:' => 'Statut de la commande : ',
    'Ordered products' => 'Produits commandés',
    'Orders' => 'Commandes',
    'Orders status' => 'Statuts des commandes',
    ...
    'Please refine your search to see the other results.' => 'Merci de préciser votre recherche pour afficher les autres résultats',
    ...
    'Save' => ' Enregistrer',
    'Save SMTP configuration' => 'Enregistrer la configuration SMTP',
    ...
    'Select State' => 'Choisissez un état',
    ...
    'Shipping taxes' => 'Taxes sur les frais de port',
    'Shipping with taxes' => 'Frais de port TTC',
    ...
    'View' => 'Voir',
    'View details and edit this order' => 'Voir le détail et modifier cette commande',
    ...
    'admin.configuration.country' => 'admin.configuration.country',
    'all' => 'tous',
    'all states' => 'tous les États',
